...
function createBallpit(canvas: HTMLCanvasElement, config: any = {}): CreateBallpitReturn {
  ...
  initialize(config);
  // IntersectionObserver can report after the first paint. Render a complete
  // initial frame immediately so the preview is never an empty canvas while
  // the animation observer is settling.
