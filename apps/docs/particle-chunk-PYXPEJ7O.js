...
// ../../packages/react/dist/particles/react-bits/Plasma/Plasma.js
...
`;
var ORIGINAL_QUALITY = 60;
var buildFragment = (iterations) => {
...
var Plasma = ({ color = "#ffffff", speed = 1, direction = "forward", scale = 1, opacity = 1, mouseInteractive = true, renderScale = 0.55, maxDpr = 1.5, targetFps = 60, iterations = 60 }) => {
  const containerRef = (0, import_react.useRef)(null);
  const mousePos = (0, import_react.useRef)({ x: 0, y: 0 });
  const pendingMouse = (0, import_react.useRef)(null);
  ...
  return (0, import_jsx_runtime.jsx)("div", { ref: containerRef, className: "plasma-container" });
};
var Plasma_default = Plasma;
