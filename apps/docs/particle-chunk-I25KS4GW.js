...
// ../../packages/react/dist/particles/react-bits/PixelBlast/PixelBlast.js
...
var PixelBlast = ({ variant = "square", pixelSize = 3, color = "#B497CF", className, style, antialias = true, patternScale = 2, patternDensity = 1, liquid = false, liquidStrength = 0.1, liquidRadius = 1, pixelSizeJitter = 0, enableRipples = true, rippleIntensityScale = 1, rippleThickness = 0.1, rippleSpeed = 0.3, liquidWobbleSpeed = 4.5, autoPauseOffscreen = true, speed = 0.5, transparent = true, edgeFade = 0.5, noiseAmount = 0 }) => {
  ...
  return (0, import_jsx_runtime.jsx)("div", { ref: containerRef, className: `pixel-blast-container ${className ?? ""}`, style, "aria-label": "PixelBlast interactive background" });
};
var PixelBlast_default = PixelBlast;
