...
// ../../packages/react/dist/particles/react-bits/Radar/Radar.js
...
`;
function Radar({ speed = 1, scale = 0.5, ringCount = 10, spokeCount = 10, ringThickness = 0.05, spokeThickness = 0.01, sweepSpeed = 1, sweepWidth = 2, sweepLobes = 1, color = "#9f29ff", backgroundColor = "#000000", falloff = 2, brightness = 1, enableMouseInteraction = true, mouseInfluence = 0.1 }) {
  ...
  return (0, import_jsx_runtime.jsx)("div", { ref: containerRef, className: "radar-container" });
}
