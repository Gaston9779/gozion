...
// ../../packages/react/dist/particles/react-bits/DotGrid/DotGrid.js
var import_jsx_runtime = __toESM(require_jsx_runtime(), 1);
var import_react = __toESM(require_react(), 1);

// ../../node_modules/.pnpm/gsap@3.15.0/node_modules/gsap/utils/VelocityTracker.js
var gsap;
var _coreInitted;
var _toArray;
var _getUnit;
...
// ../../node_modules/.pnpm/gsap@3.15.0/node_modules/gsap/InertiaPlugin.js
var gsap2;
var _coreInitted2;
var _parseEase;
var _toArray2;
...
var DotGrid = ({ dotSize = 16, gap = 32, baseColor = "#5227FF", activeColor = "#5227FF", proximity = 150, speedTrigger = 100, shockRadius = 250, shockStrength = 5, maxSpeed = 5e3, resistance = 750, returnDuration = 1.5, className = "", style }) => {
  ...
  const baseRgb = (0, import_react.useMemo)(() => hexToRgb(baseColor), [baseColor]);
  const activeRgb = (0, import_react.useMemo)(() => hexToRgb(activeColor), [activeColor]);
  const circlePath = (0, import_react.useMemo)(() => {
  ...
  const buildGrid = (0, import_react.useCallback)(() => {
  ...
  return (0, import_jsx_runtime.jsx)("section", { className: `dot-grid ${className}`, style, children: (0, import_jsx_runtime.jsx)("div", { ref: wrapperRef, className: "dot-grid__wrap", children: (0, import_jsx_runtime.jsx)("canvas", { ref: canvasRef, className: "dot-grid__canvas" }) }) });
};
