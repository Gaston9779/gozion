...
// ../../packages/react/src/particles/react-bits/PixelSnow/PixelSnow.tsx
...
function PixelSnow({
  ...
  const variantValue = (0, import_react.useMemo)(() => {
    return variant === "round" ? 1 : variant === "snowflake" ? 2 : 0;
  }, [variant]);
  const colorVector = (0, import_react.useMemo)(() => {
  ...
  (0, import_react.useEffect)(() => {
    ...
    const animate = () => {
      ...
      if (isVisibleRef.current) {
        material.uniforms.uTime.value = (performance.now() - startTime) * 1e-3;
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { ref: containerRef, className: `pixel-snow-container ${className}`, style });
}
export {
  PixelSnow as default
};
