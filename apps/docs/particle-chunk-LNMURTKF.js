...
// ../../packages/react/dist/particles/react-bits/Lightfall/Lightfall.js
...
`;
var Lightfall = ({ className, dpr, paused = false, colors = ["#A6C8FF", "#5227FF", "#FF9FFC"], backgroundColor = "#0A29FF", speed = 0.5, streakCount = 2, streakWidth = 1, streakLength = 1, glow = 1, density = 0.6, twinkle = 1, zoom = 3, backgroundGlow = 0.5, opacity = 1, mouseInteraction = true, mouseStrength = 0.5, mouseRadius = 1, mouseDampening = 0.15, mixBlendMode }) => {
  ...
  return (0, import_jsx_runtime.jsx)("div", { ref: containerRef, className: `lightfall-container ${className ?? ""}`, style: {
    ...mixBlendMode && { mixBlendMode }
  } });
};
var Lightfall_default = Lightfall;
