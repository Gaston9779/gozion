...
// ../../packages/react/src/particles/react-bits/SideRays/SideRays.tsx
...
void main() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { ref: containerRef, className: `side-rays-container ${className}`.trim() });
};
var SideRays_default = SideRays;
export {
  SideRays_default as default
};
