...
// ../../packages/react/dist/particles/react-bits/Topography/Topography.js
...
var Topography = ({ lowColor = "#5227FF", midColor = "#FF9FFC", highColor = "#FFFFFF", speed = 0.35, morphAmount = 3, morphSpeed = 0.05, bands = 2, thickness = 0.01, scale = 1, pixelSize = 1, glow = 0.5, colorMode = "elevation", contrast = 3, brightness = 1, fillBands = false, opacity = 1, grain = true, grainIntensity = 0.05, mouseInteraction = true, mouseRadius = 0.3, mouseStrength = 0.4, className = "" }) => {
  ...
  (0, import_react.useEffect)(() => {
    ...
    u.uFillBands.value = fillBands ? 1 : 0;
  ...
  return (0, import_jsx_runtime.jsx)("div", { ref: containerRef, className: `topography-container ${className}`.trim() });
};
var Topography_default = Topography;
