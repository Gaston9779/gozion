...
// ../../packages/react/dist/particles/react-bits/PlasmaWave/PlasmaWave.js
...
function PlasmaWave(props) {
  const { xOffset = 0, yOffset = 0, rotationDeg = 0, focalLength = 0.8, speed1 = 0.05, speed2 = 0.05, dir2 = 1, bend1 = 1, bend2 = 0.5, colors = ["#A855F7", "#06B6D4"] } = props;
  ...
  (0, import_react.useEffect)(() => {
    ...
    let animateId;
    const update = (now) => {
      const { xOffset: xOff = 0, yOffset: yOff = 0, rotationDeg: rot = 0, focalLength: fLen = 0.8, speed1: s1 = 0.05, speed2: s2 = 0.05, dir2: d2 = 1, bend1: b1 = 1, bend2: b2 = 0.5, colors: cols = ["#A855F7", "#06B6D4"] } = propsRef.current;
      uniformOffset[0] = xOff;
      uniformOffset[1] = yOff;
      program.uniforms.iTime.value = (now - startTime) * 1e-3;
  ...
  return (0, import_jsx_runtime.jsx)("div", { ref: containerRef, className: "plasma-wave-container" });
}
