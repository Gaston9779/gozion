...
// ../../packages/react/dist/particles/react-bits/Prism/Prism.js
var import_jsx_runtime = __toESM(require_jsx_runtime(), 1);
var import_react = __toESM(require_react(), 1);
var Prism = ({ height = 3.5, baseWidth = 5.5, animationType = "rotate", glow = 1, offset = { x: 0, y: 0 }, noise = 0.5, transparent = true, scale = 3.6, hueShift = 0, colorFrequency = 1, hoverStrength = 2, inertia = 0.05, bloom = 1, suspendWhenOffscreen = false, timeScale = 0.5 }) => {
  ...
  (0, import_react.useEffect)(() => {
    ...
    const SCALE = Math.max(1e-3, scale);
  ...
  return (0, import_jsx_runtime.jsx)("div", { className: "prism-container", ref: containerRef });
};
