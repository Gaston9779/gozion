...
// ../../packages/react/dist/particles/react-bits/Threads/Threads.js
...
`;
var Threads = ({ color = [1, 1, 1], amplitude = 1, distance = 0, enableMouseInteraction = false, ...rest }) => {
  const containerRef = (0, import_react.useRef)(null);
  const animationFrameId = (0, import_react.useRef)(0);
  const propsRef = (0, import_react.useRef)({ color, amplitude, distance, enableMouseInteraction });
  ...
  (0, import_react.useEffect)(() => {
    ...
    function update(t) {
      ...
      if (!isVisible || document.hidden)
        return;
      const { color: color2, amplitude: amplitude2, distance: distance2, enableMouseInteraction: enableMouseInteraction2 } = propsRef.current;
      program.uniforms.uColor.value.set(...color2);
      program.uniforms.uAmplitude.value = amplitude2;
      program.uniforms.uDistance.value = distance2;
      if (enableMouseInteraction2) {
  ...
  return (0, import_jsx_runtime.jsx)("div", { ref: containerRef, className: "threads-container", ...rest });
};
