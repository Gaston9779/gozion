...
// ../../packages/react/dist/particles/react-bits/LightPillar/LightPillar.js
var import_jsx_runtime = __toESM(require_jsx_runtime(), 1);
var import_react = __toESM(require_react(), 1);
var LightPillar = ({ topColor = "#5227FF", bottomColor = "#FF9FFC", intensity = 1, rotationSpeed = 0.3, interactive = false, className = "", glowAmount = 5e-3, pillarWidth = 3, pillarHeight = 0.4, noiseIntensity = 0.5, mixBlendMode = "screen", pillarRotation = 0, quality = "high" }) => {
  ...
  const mouseRef = (0, import_react.useRef)(new Vector2(0, 0));
  const timeRef = (0, import_react.useRef)(0);
  const rotationSpeedRef = (0, import_react.useRef)(rotationSpeed);
  const [webGLSupported, setWebGLSupported] = (0, import_react.useState)(true);
  ...
  if (!webGLSupported) {
    return (0, import_jsx_runtime.jsx)("div", { className: `light-pillar-fallback ${className}`, style: { mixBlendMode }, children: "WebGL not supported" });
  }
  return (0, import_jsx_runtime.jsx)("div", { ref: containerRef, className: `light-pillar-container ${className}`, style: { mixBlendMode } });
};
var LightPillar_default = LightPillar;
