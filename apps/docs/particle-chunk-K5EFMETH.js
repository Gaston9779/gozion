...
// ../../packages/react/src/particles/react-bits/LightTunnel/LightTunnel.tsx
...
var LightTunnel = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { ref: containerRef, className: `light-tunnel-container ${className}`.trim() });
};
var LightTunnel_default = LightTunnel;
export {
  LightTunnel_default as default
};
