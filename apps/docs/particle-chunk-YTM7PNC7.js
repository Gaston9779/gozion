...
// ../../packages/react/dist/particles/react-bits/Silk/Silk.js
...
var SilkPlane = (0, import_react.forwardRef)(function SilkPlane2({ uniforms }, ref) {
  ...
  return (0, import_jsx_runtime.jsxs)("mesh", { ref, children: [(0, import_jsx_runtime.jsx)("planeGeometry", { args: [1, 1, 1, 1] }), (0, import_jsx_runtime.jsx)("shaderMaterial", { uniforms, vertexShader, fragmentShader })] });
});
...
var Silk = ({ speed = 5, scale = 1, color = "#7B7481", noiseIntensity = 1.5, rotation = 0 }) => {
  ...
  return (0, import_jsx_runtime.jsx)(Canvas, { dpr: [1, 2], frameloop: "always", children: (0, import_jsx_runtime.jsx)(SilkPlane, { ref: meshRef, uniforms }) });
};
