...
// ../../packages/react/src/particles/react-bits/LightPillar/LightPillar.tsx
...
var LightPillar = ({
  ...
  if (!webGLSupported) {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: `light-pillar-fallback ${className}`, style: { mixBlendMode }, children: "WebGL not supported" });
  }
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { ref: containerRef, className: `light-pillar-container ${className}`, style: { mixBlendMode } });
};
var LightPillar_default = LightPillar;
export {
  LightPillar_default as default
};
