...
// ../../packages/react/src/particles/react-bits/Hyperspeed/Hyperspeed.tsx
...
var distortions = {
  ...
  turbulentDistortion: {
    ...
    getJS: (progress, time) => {
      ...
      const distortion = new Vector3(
        getX(progress) - getX(progress + 7e-3),
        getY(progress) - getY(progress + 7e-3),
        0
      );
...
var Hyperspeed = ({ effectOptions = DEFAULT_EFFECT_OPTIONS }) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { id: "lights", ref: hyperspeed });
};
var Hyperspeed_default = Hyperspeed;
export {
  Hyperspeed_default as default
};
