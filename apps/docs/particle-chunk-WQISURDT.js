...
// ../../packages/react/src/particles/react-bits/SlicedWaves/SlicedWaves.tsx
...
var SlicedWaves = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { ref: containerRef, className: `sliced-waves-container ${className}`.trim() });
};
var SlicedWaves_default = SlicedWaves;
export {
  SlicedWaves_default as default
};
