...
// ../../packages/react/src/particles/react-bits/Scanner/Scanner.tsx
...
var Scanner = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { ref: containerRef, className: `scanner-container ${className}`.trim() });
};
