...
// ../../packages/react/dist/particles/react-bits/MoltenMetal/MoltenMetal.js
...
var colorModeToFloat = (mode) => mode === "ember" ? 1 : mode === "frost" ? 2 : 0;
...
var MoltenMetal = ({ color1 = "#5227FF", color2 = "#FF9FFC", color3 = "#FFFFFF", speed = 0.35, scale = 4, detail = 3, glow = 1.6, coreSize = 0.1, swirl = 1, fold = -0.2, blackPoint = 0.05, brightness = 1.3, colorMode = "molten", grain = true, grainIntensity = 0.05, mouseInteraction = true, mouseStrength = 0.3, opacity = 1, className = "" }) => {
  ...
  (0, import_react.useEffect)(() => {
    ...
    u.uGlow.value = glow;
    u.uCoreSize.value = Math.max(coreSize, 1e-3);
  ...
  return (0, import_jsx_runtime.jsx)("div", { ref: containerRef, className: `molten-metal-container ${className}`.trim() });
};
var MoltenMetal_default = MoltenMetal;
