...
// ../../packages/react/dist/particles/react-bits/ColorBends/ColorBends.js
...
`;
function ColorBends({ className, style, rotation = 90, speed = 0.2, colors = [], transparent = true, autoRotate = 0, scale = 1, frequency = 1, warpStrength = 1, mouseInfluence = 1, parallax = 0.5, noise = 0.15, iterations = 1, intensity = 1.5, bandWidth = 6 }) {
  ...
  const rotationRef = (0, import_react.useRef)(rotation);
  const autoRotateRef = (0, import_react.useRef)(autoRotate);
  const pointerTargetRef = (0, import_react.useRef)(new Vector2(0, 0));
  const pointerCurrentRef = (0, import_react.useRef)(new Vector2(0, 0));
  const pointerSmoothRef = (0, import_react.useRef)(8);
  ...
  return (0, import_jsx_runtime.jsx)("div", { ref: containerRef, className: `color-bends-container ${className}`, style });
}
