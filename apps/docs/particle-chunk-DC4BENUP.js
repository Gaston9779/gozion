...
// ../../packages/react/src/particles/react-bits/Topography/Topography.tsx
...
var Topography = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { ref: containerRef, className: `topography-container ${className}`.trim() });
};
var Topography_default = Topography;
export {
  Topography_default as default
};
