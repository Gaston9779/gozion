...
// ../../packages/react/dist/particles/react-bits/SideRays/SideRays.js
...
var SideRays = ({ speed = 2.5, rayColor1 = "#EAB308", rayColor2 = "#96c8ff", intensity = 2, spread = 2, origin = "top-right", tilt = 0, saturation = 1.5, blend = 0.75, falloff = 1.6, opacity = 1, className = "" }) => {
...
void main() {
  ...
  return (0, import_jsx_runtime.jsx)("div", { ref: containerRef, className: `side-rays-container ${className}`.trim() });
};
var SideRays_default = SideRays;
