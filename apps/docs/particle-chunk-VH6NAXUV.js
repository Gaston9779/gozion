...
// ../../packages/react/dist/particles/react-bits/WebThreads/WebThreads.js
...
var WebThreads = ({ color1 = "#5227FF", color2 = "#FF9FFC", color3 = "#FFFFFF", speed = 0.2, threadCount = 6, frequency = 5, spread = 0.18, taper = 1, position = 0.5, fanMode = "center", glow = 0.02, falloff = 0.6, thickness = 1.1, brightness = 0.6, opacity = 1, mirror = true, shimmer = false, grain = true, grainIntensity = 0.05, mouseInteraction = true, mouseStrength = 0.3, className = "" }) => {
  const containerRef = (0, import_react.useRef)(null);
  const mouseRef = (0, import_react.useRef)({ enabled: true, strength: 0.3 });
  ...
  return (0, import_jsx_runtime.jsx)("div", { ref: containerRef, className: `web-threads-container ${className}`.trim() });
};
var WebThreads_default = WebThreads;
