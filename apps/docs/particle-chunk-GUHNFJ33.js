...
// ../../packages/react/dist/particles/react-bits/GradientWaves/GradientWaves.js
...
var GradientWaves = ({ horizonColor = "#5227FF", waveColor = "#FF9FFC", crestColor = "#FFFFFF", speed = 0.4, amplitude = 2.5, waveScale = 0.6, waveRatio = 0.9, swell = 35, turbulence = 20, tilt = 1.11, zoom = 1, height = 5.5, fogDepth = 15, detail = "medium", brightness = 1, opacity = 1, mouseInteraction = true, parallaxStrength = 0.5, grain = true, grainIntensity = 0.05, className = "" }) => {
  ...
  return (0, import_jsx_runtime.jsx)("div", { ref: containerRef, className: `gradient-waves-container ${className}`.trim() });
};
var GradientWaves_default = GradientWaves;

export {
  GradientWaves_default
};
