...
// ../../packages/react/src/particles/react-bits/ColorBends/ColorBends.tsx
...
function ColorBends({
  ...
  (0, import_react.useEffect)(() => {
    ...
    if (renderer) renderer.setClearColor(0, transparent ? 0 : 1);
  }, [
    rotation,
    autoRotate,
    speed,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { ref: containerRef, className: `color-bends-container ${className}`, style });
}
export {
  ColorBends as default
};
