...
// ../../packages/react/dist/particles/react-bits/LineWaves/LineWaves.js
...
`;
function LineWaves({ speed = 0.3, innerLineCount = 32, outerLineCount = 36, warpIntensity = 1, rotation = -45, edgeFadeWidth = 0, colorCycleSpeed = 1, brightness = 0.2, color1 = "#ffffff", color2 = "#ffffff", color3 = "#ffffff", enableMouseInteraction = true, mouseInfluence = 2 }) {
  ...
  return (0, import_jsx_runtime.jsx)("div", { ref: containerRef, className: "line-waves-container" });
}
