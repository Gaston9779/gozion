...
// ../../packages/react/dist/particles/react-bits/AcidSquares/AcidSquares.js
...
var DETAIL_STEPS = { low: 20, medium: 32, high: 48 };
var stepsFor = (detail) => DETAIL_STEPS[detail] || DETAIL_STEPS.medium;
...
var AcidSquares = ({ color1 = "#5227FF", color2 = "#A855F7", color3 = "#FFFFFF", detail = "medium", speed = 0.7, waveDepth = 1, zoom = 1.3, density = 10, glow = 1, exposure = 2700, spread = 0.3, stepSize = 2e-3, colorShift = 0, contrast = 1, brightness = 1, opacity = 1, mouseInteraction = true, mouseStrength = 0.1, mouseRadius = 0.35, blur = 0, grain = true, grainIntensity = 0.05, className = "" }) => {
  const containerRef = (0, import_react.useRef)(null);
  const mouseTarget = (0, import_react.useRef)([0, 0]);
  const mouseCurrent = (0, import_react.useRef)([0, 0]);
  const enableMouseRef = (0, import_react.useRef)(mouseInteraction);
  const mouseStrengthRef = (0, import_react.useRef)(mouseStrength);
  const mouseActive = (0, import_react.useRef)(0);
  const mouseActiveTarget = (0, import_react.useRef)(0);
  const blurRef = (0, import_react.useRef)(blur);
  const grainRef = (0, import_react.useRef)(grain);
  const grainIntensityRef = (0, import_react.useRef)(grainIntensity);
  (0, import_react.useEffect)(() => {
    ...
    const renderFrame = () => {
      ...
      if (blurRef.current > 0) {
        ...
        pu.uRadius.value = blurRef.current * 14;
  ...
  return (0, import_jsx_runtime.jsx)("div", { ref: containerRef, className: `acid-squares-container ${className}`.trim() });
};
var AcidSquares_default = AcidSquares;
