...
// ../../packages/react/src/particles/react-bits/WebThreads/WebThreads.tsx
...
var WebThreads = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { ref: containerRef, className: `web-threads-container ${className}`.trim() });
};
var WebThreads_default = WebThreads;
export {
  WebThreads_default as default
};
