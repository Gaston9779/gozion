...
// ../../packages/react/src/particles/react-bits/LightRays/LightRays.tsx
...
void main() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { ref: containerRef, className: `light-rays-container ${className}`.trim() });
};
var LightRays_default = LightRays;
export {
  LightRays_default as default
};
