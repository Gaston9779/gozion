...
// ../../packages/react/dist/particles/react-bits/Scanner/Scanner.js
...
var directionToFloat = (dir) => dir === "horizontal" ? 1 : dir === "diagonal" ? 2 : 0;
...
var Scanner = ({ color1 = "#5227FF", color2 = "#FF9FFC", color3 = "#FFFFFF", speed = 0.5, sweepSpeed = 0.25, sweepWidth = 1.6, sweepFalloff = 6, scale = 1.5, frequency = 2, ripple = 0.22, bandDensity = 11, lineSharpness = 5.5, glow = 0.22, scanDirection = "vertical", colorSpread = 0.7, brightness = 1, contrast = 1.15, softness = 1.4, vignette = 0.45, scanline = true, grain = true, grainIntensity = 0.05, opacity = 1, mouseInteraction = true, mouseRadius = 0.5, mouseStrength = 0.5, className = "" }) => {
  ...
  (0, import_react.useEffect)(() => {
    ...
    u.uScanline.value = scanline ? 1 : 0;
  ...
  return (0, import_jsx_runtime.jsx)("div", { ref: containerRef, className: `scanner-container ${className}`.trim() });
};
