...
// ../../packages/react/src/particles/react-bits/MoltenMetal/MoltenMetal.tsx
...
var MoltenMetal = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { ref: containerRef, className: `molten-metal-container ${className}`.trim() });
};
var MoltenMetal_default = MoltenMetal;
export {
  MoltenMetal_default as default
};
