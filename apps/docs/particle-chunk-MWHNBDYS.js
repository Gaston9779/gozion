...
// ../../packages/react/src/particles/react-bits/Beams/Beams.tsx
...
var CanvasWrapper = ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Canvas, { dpr: [1, 2], frameloop: "always", className: "beams-container", children });
...
var Beams = ({
  ...
  const beamMaterial = (0, import_react2.useMemo)(
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CanvasWrapper, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("group", { rotation: [0, 0, degToRad(rotation)], children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PlaneNoise, { ref: meshRef, material: beamMaterial, count: beamNumber, width: beamWidth, height: beamHeight }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DirLight, { color: lightColor, position: [0, 3, 10] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ambientLight", { intensity: 1 }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("color", { attach: "background", args: ["#000000"] }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PerspectiveCamera, { makeDefault: true, position: [0, 0, 20], fov: 30 })
  ] });
};
...
var MergedPlanes = (0, import_react2.forwardRef)(({ material, width, count, height }, ref) => {
  ...
  const geometry = (0, import_react2.useMemo)(
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("mesh", { ref: mesh, geometry, material });
});
MergedPlanes.displayName = "MergedPlanes";
var PlaneNoise = (0, import_react2.forwardRef)((props, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MergedPlanes, { ref, material: props.material, width: props.width, count: props.count, height: props.height }));
...
var DirLight = ({ position, color }) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("directionalLight", { ref: dir, color, intensity: 1, position });
};
var Beams_default = Beams;
export {
  Beams_default as default
};
