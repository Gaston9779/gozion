...
// ../../packages/react/dist/particles/react-bits/SlicedWaves/SlicedWaves.js
...
var SlicedWaves = ({ color1 = "#FF9FFC", color2 = "#5227FF", color3 = "#B497CF", columns = 14, rows = 8, barThickness = 0.1, speed = 0.35, travel = 0.7, waveSpread = 0.9, rowOffset = 1, softness = 0.05, glow = 0, brightness = 1, contrast = 1, opacity = 0.5, orientation = "horizontal", alternate = false, mouseInteraction = true, mouseStrength = 1, mouseRadius = 0.3, grain = true, grainIntensity = 0.05, className = "" }) => {
  ...
  (0, import_react.useEffect)(() => {
    ...
    u.uVertical.value = orientation === "vertical" ? 1 : 0;
    u.uAlternate.value = alternate ? 1 : 0;
  ...
  return (0, import_jsx_runtime.jsx)("div", { ref: containerRef, className: `sliced-waves-container ${className}`.trim() });
};
var SlicedWaves_default = SlicedWaves;
