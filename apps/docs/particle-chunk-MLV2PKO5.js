...
// ../../packages/react/src/particles/react-bits/AcidSquares/AcidSquares.tsx
...
var AcidSquares = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { ref: containerRef, className: `acid-squares-container ${className}`.trim() });
};
var AcidSquares_default = AcidSquares;
export {
  AcidSquares_default as default
};
