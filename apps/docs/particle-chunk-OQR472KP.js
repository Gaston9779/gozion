...
// ../../packages/react/src/particles/react-bits/GradientWaves/GradientWaves.tsx
...
var GradientWaves = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { ref: containerRef, className: `gradient-waves-container ${className}`.trim() });
};
var GradientWaves_default = GradientWaves;
export {
  GradientWaves_default as default
};
