...
// ../../packages/react/dist/particles/react-bits/Ferrofluid/Ferrofluid.js
...
`;
var Ferrofluid = ({ className, dpr, paused = false, colors = ["#ffffff", "#ffffff", "#ffffff"], speed = 0.5, scale = 1.6, turbulence = 1, fluidity = 0.1, rimWidth = 0.2, sharpness = 2.5, shimmer = 1.5, glow = 2, flowDirection = "down", opacity = 1, mouseInteraction = true, mouseStrength = 1, mouseRadius = 0.35, mouseDampening = 0.15, mixBlendMode }) => {
  ...
  return (0, import_jsx_runtime.jsx)("div", { ref: containerRef, className: `ferrofluid-container ${className ?? ""}`, style: {
    ...mixBlendMode && { mixBlendMode }
  } });
};
var Ferrofluid_default = Ferrofluid;
