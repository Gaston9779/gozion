...
// ../../packages/react/dist/particles/react-bits/RippleGrid/RippleGrid.js
var import_jsx_runtime = __toESM(require_jsx_runtime(), 1);
var import_react = __toESM(require_react(), 1);
var RippleGrid = ({ enableRainbow = false, gridColor = "#ffffff", rippleIntensity = 0.05, gridSize = 10, gridThickness = 15, fadeDistance = 1.5, vignetteStrength = 2, glowIntensity = 0.1, opacity = 1, gridRotation = 0, mouseInteraction = true, mouseInteractionRadius = 1 }) => {
  const containerRef = (0, import_react.useRef)(null);
  const mousePositionRef = (0, import_react.useRef)({ x: 0.5, y: 0.5 });
  const targetMouseRef = (0, import_react.useRef)({ x: 0.5, y: 0.5 });
  const mouseInfluenceRef = (0, import_react.useRef)(0);
...
void main() {
  ...
  return (0, import_jsx_runtime.jsx)("div", { ref: containerRef, className: "ripple-grid-container" });
};
var RippleGrid_default = RippleGrid;
