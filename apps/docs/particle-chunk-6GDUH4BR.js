...
// ../../packages/react/dist/particles/react-bits/Dither/Dither.js
...
var RetroEffect = (0, import_react2.forwardRef)((props, ref) => {
  ...
  return (0, import_jsx_runtime2.jsx)(WrappedRetroEffect, { ref, colorNum, pixelSize });
});
...
function DitheredWaves({ waveSpeed, waveFrequency, waveAmplitude, waveColor, colorNum, pixelSize, disableAnimation, enableMouseInteraction, mouseRadius }) {
  ...
  return (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [(0, import_jsx_runtime2.jsxs)("mesh", { ref: mesh, scale: [viewport.width, viewport.height, 1], children: [(0, import_jsx_runtime2.jsx)("planeGeometry", { args: [1, 1] }), (0, import_jsx_runtime2.jsx)("shaderMaterial", { vertexShader: waveVertexShader, fragmentShader: waveFragmentShader, uniforms: waveUniformsRef.current })] }), (0, import_jsx_runtime2.jsx)(Ne, { children: (0, import_jsx_runtime2.jsx)(RetroEffect, { colorNum, pixelSize }) }), (0, import_jsx_runtime2.jsxs)("mesh", { onPointerMove: handlePointerMove, position: [0, 0, 0.01], scale: [viewport.width, viewport.height, 1], visible: false, children: [(0, import_jsx_runtime2.jsx)("planeGeometry", { args: [1, 1] }), (0, import_jsx_runtime2.jsx)("meshBasicMaterial", { transparent: true, opacity: 0 })] })] });
}
function Dither({ waveSpeed = 0.05, waveFrequency = 3, waveAmplitude = 0.3, waveColor = [0.5, 0.5, 0.5], colorNum = 4, pixelSize = 2, disableAnimation = false, enableMouseInteraction = true, mouseRadius = 1 }) {
  return (0, import_jsx_runtime2.jsx)(Canvas, { className: "dither-container", camera: { position: [0, 0, 6] }, dpr: 1, gl: { antialias: true, preserveDrawingBuffer: true }, children: (0, import_jsx_runtime2.jsx)(DitheredWaves, { waveSpeed, waveFrequency, waveAmplitude, waveColor, colorNum, pixelSize, disableAnimation, enableMouseInteraction, mouseRadius }) });
}
