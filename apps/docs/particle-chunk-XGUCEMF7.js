...
// ../../packages/react/dist/particles/react-bits/ShapeGrid/ShapeGrid.js
var import_jsx_runtime = __toESM(require_jsx_runtime(), 1);
var import_react = __toESM(require_react(), 1);
var ShapeGrid = ({ direction = "right", speed = 1, borderColor = "#999", squareSize = 40, hoverFillColor = "#222", shape = "square", hoverTrailAmount = 0 }) => {
  const canvasRef = (0, import_react.useRef)(null);
  const requestRef = (0, import_react.useRef)(null);
  const numSquaresX = (0, import_react.useRef)(0);
  const numSquaresY = (0, import_react.useRef)(0);
  const gridOffset = (0, import_react.useRef)({ x: 0, y: 0 });
  const hoveredSquareRef = (0, import_react.useRef)(null);
  const trailCells = (0, import_react.useRef)([]);
  const cellOpacities = (0, import_react.useRef)(/* @__PURE__ */ new Map());
  ...
  return (0, import_jsx_runtime.jsx)("canvas", { ref: canvasRef, className: "shapegrid-canvas" });
};
var ShapeGrid_default = ShapeGrid;
