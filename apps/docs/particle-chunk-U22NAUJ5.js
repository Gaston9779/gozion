...
// ../../packages/react/dist/particles/react-bits/LightTunnel/LightTunnel.js
...
var LightTunnel = ({ cableColor = "#A855F7", pulseColor = "#A855F7", tunnelColor = "#5227FF", tunnelOpacity = 0, speed = 0.1, flowDirection = "outward", pulseSpeed = 2, pulseLength = 0.28, pulseBlend = 1, pulseWidth = 1, cableCount = 20, thickness = 0.35, rimWidth = 0.15, waviness = 0.3, sway = 0.5, size = 1, centerX = 0, centerY = 0, glow = 1, fadeNear = 0.5, fadeFar = 2, brightness = 1, colorVariance = true, grain = true, grainIntensity = 0.05, opacity = 1, mouseInteraction = true, mouseStrength = 0.1, className = "" }) => {
  const containerRef = (0, import_react.useRef)(null);
  const mouseEnabledRef = (0, import_react.useRef)(mouseInteraction);
  ...
  (0, import_react.useEffect)(() => {
    ...
    u.uFlowDir.value = flowDirection === "outward" ? -1 : 1;
    ...
    u.uColorVariance.value = colorVariance ? 1 : 0;
  ...
  return (0, import_jsx_runtime.jsx)("div", { ref: containerRef, className: `light-tunnel-container ${className}`.trim() });
};
var LightTunnel_default = LightTunnel;
